package com.yocto.controller.system.login;
...
import com.yocto.entity.system.Menu;
import com.yocto.entity.system.Role;
import com.yocto.entity.system.User;
import com.yocto.service.system.buttonrights.ButtonrightsManager;
import com.yocto.service.system.fhbutton.FhbuttonManager;
...
import com.yocto.util.RightsHelper;
...
public class LoginController extends BaseController {
		...
		if (null != KEYDATA && KEYDATA.length == 3) {
			...
			if (null == code || "".equals(code)) {// 判断效验码
				...
				if (pd != null) {
					...
					String url = requestURL.substring(0, request.getRequestURL().indexOf("/login_login"));
					if ("http://biz.shanghaisf.cn".equals(url) && "0".equals(user.getIsUrl())) {
						errInfo = "您没有权限访问！";
					} else {
						// shiro加入身份验证
	...
	public ModelAndView defaultPage() throws Exception {
		...
		mv.addObject("pd", pd);
		// 求出前六个月第一天的时间
		String first = TimeUtil.getPreviousMonthSix() + " 00:00:00";
		// 求出上个月的最后一天
		String end = TimeUtil.getPreviousMonthEnd() + " 23:59:59";
		pd.put("first", first);
		pd.put("end", end);
