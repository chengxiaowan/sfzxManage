...
public class Page {
	...
	public String getPageStr() {
		...
		if (totalResult > 0) {
			sb.append("	<ul class=\"pagination pull-right form-group-sm\">\n");
			if (currentPage == 1) {
				sb.append("	<li><a>共<font color=red>" + totalResult + "</font>条</a></li>\n");
				sb.append("	<li><input class=\"form-control\" type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:70px;height:28px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
			...
			for (int i = startTag; i <= totalPage && i <= endTag; i++) {
				if (currentPage == i)
					sb.append("<li class=\"active\"><a><font color=''>" + i + "</font></a></li>\n");
				else
			...
			sb.append("	<li><select class=\"form-control\" title='显示条数' style=\"width:65px;height:28px;float:left;\" onchange=\"changeCount(this.value)\">\n");
