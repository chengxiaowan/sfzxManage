package com.yocto.service.system.user.impl;
...
public class UserService implements UserManager {
	...
	public void delTp(PageData pd) throws Exception {
		dao.delete("UserMapper.delTp", pd);
	}
