					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top: 5px;">
								<thead>
									<tr>
										<th class="center" style="width: 30px;"><label><input class="ace" type="checkbox" id="zcheckbox" /><span class="lbl"></span></label></th>
							...
							<div class="page-header position-relative">
								<table style="width: 100%;">
									<tr>
										<td style="vertical-align: top;"><c:if test="${QX.del == 1 }">
