...
<body>
	...
	<table style="width: 100%;" border="0">
		<tr>
			...
			<td style="width: 85%;" valign="top"><iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/menu.do?MENU_ID=${MENU_ID}" style="margin: 0 auto; width: 100%; height: 100%;"></iframe>
			</td>
		</tr>
	</table>
