										...
										<c:when test="${not empty roleList}">
											...
											<c:forEach items="${roleList}" var="role" varStatus="vs">
												<td style="width: 100px;" class="center"
													...
													onMouseMove="javascript:this.bgColor='#FFC926';"><a href="buttonrights/list.do?ROLE_ID=${role.ROLE_ID }" style="text-decoration: none; display: block;"><i
														class="menu-icon fa fa-users"></i><font color="#666666">${role.ROLE_NAME }</font></a></td>
												...
												<tr>
													...
													<c:if test="${QX.edit == 1 }">
														...
														<c:forEach items="${buttonlist}" var="fhbutton" varStatus="vsb">
															...
															<td class='center' style="height: 20px;"><label> <input name="switch-field-1" onclick="upRb('${var.ROLE_ID}','${fhbutton.FHBUTTON_ID}')" class="ace ace-switch ace-switch-3"
																	type="checkbox" <c:if test="${rbvalue == 1 }">checked="checked"</c:if>> <span class="lbl"></span>
															</label></td>
