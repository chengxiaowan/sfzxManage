	...
	<div class="wrapper wrapper-content animated fadeInUp">
		...
		<div class="ibox-content">
			<div class="row">
				<div class="col-xs-12">
					<!-- 检索  -->
					<form class="form-inline" role="form" action="showView/backdetail/list.do" method="post" name="customerForm" id="customerForm">
			...
			<table id="simple-table" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th class="center">本次回款金额</th>
						<th class="center">当前余额</th>
						<th class="center"><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>本次回款时间</th>
