			...
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="tabbable">
								...
								<div class="tab-content">
									<div id="home" class="tab-pane in active">
										<form action="taskAssign/debtRoport/${msg }.do"  name="visitForm" id="visitForm" method="post"  class="form form-horizontal" >
										...
										<div class="row">
												<div id="zhongxin" style="padding-top: 13px;">
													    ...
													    <div class="form-group">
													        ...
													        <div class="col-sm-8">
													          <select class="form-control chosen-select-sale" data-validate="require" name="userId" id="userId" style="width: 98%">
														        </select>
													        </div>
													    </div>
														</div>
					...
					<div class="text-center">
						<a class="btn btn-mini btn-primary" onclick="save();">保存</a> <a class="btn btn-mini btn-danger" onclick="yocto.closeChildLayer();"><i class="fa fa-remove"></i> 取消</a>
					</div>
				</div>
				<!-- /.col -->
			</div>
