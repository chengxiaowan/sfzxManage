const config = {
	...
	api_detail: '/mainIndex/showDxSwgwXstjDetail', //电销商务顾问业绩目标完成情况
	...
	window.app = new Vue({
		...
		watch: {
			'dxmonth2': function(val) {
				this.getYjmb2(this.dxmonth2, 0, 1); //最后的1为了控制时间切换时进度盘更新
			},
			'dxmonth3': function(val) {
				this.getYjmb3(this.dxmonth3, 1, 1);
			},
			'dxmonth4': function(val) {
				this.getYjmb4(this.dxmonth4, 2, 1);
			},
		...
		mounted() {
			const that = this
			let nowDate = that.nowMonth()
			let isMonth = nowDate.split("-")[1]
			let isdate = new Date;
			let isYear = isdate.getFullYear();
			if(isMonth == '01' || isMonth == '02' || isMonth == '03') {
				this.dxmonth2 = Number(isYear) - 1
				this.dxmonth3 = Number(isYear) - 1
				this.dxmonth4 = Number(isYear) - 1
			} else {
				this.dxmonth2 = isYear
				this.dxmonth3 = isYear
				this.dxmonth4 = isYear
			}
			laydate.render({
				elem: '#dxmonth2',
				type: 'year',
			...
			this.getYjmb2(this.dxmonth2, 0);
			this.getYjmb3(this.dxmonth3, 1);
			this.getYjmb4(this.dxmonth4, 2);
		...
		methods: {
			...
			dxhx2(hhd, hhd1, gxtime) {
				...
				pieChart.on("click", function(params) {
					var html = '/static/page/index/saler_turnover_list.html?startTime=' + riqi + '&endTime=' + riqi1 + '&dxswgwId=' + that.saleId2 + "&flag=1" + '&htz=1';
					var index = layer.open({
						type: 2,
						title: '电销商务顾问业绩目标-签约客户数完成情况',
						content: html,
						area: ['100%', '100%']
					});
			...
			dxhx3(hhd, hhd1, gxtime) {
				...
				pieChart.off("click");
				pieChart.on("click", function(params) {
					var html = '/static/page/index/saler_turnover_list.html?startTime=' + riqi + '&endTime=' + riqi1 + '&dxswgwId=' + that.saleId3 + "&flag=2" + '&htz=1';
					var index = layer.open({
						type: 2,
						title: '电销商务顾问业绩目标-委案金额',
						content: html,
						area: ['100%', '100%']
					});
			...
			khs(){
				let that = this
				var html = '/static/page/index/saler_turnover_list.html?startTime=' + that.a2 + '&endTime=' + that.b2 + '&dxswgwId=' + that.c2 + "&flag=1" + '&htz=1';
					var index = layer.open({
						type: 2,
			...
			ddje(){
				let that = this
				var html = '/static/page/index/saler_turnover_list.html?startTime=' + that.a3 + '&endTime=' + that.b3 + '&dxswgwId=' + that.c3 + "&flag=2" + '&htz=1';
					var index = layer.open({
						type: 2,
						title: '商务顾问业绩目标-委案金额',
						content: html,
