				...
				<div class="col-xs-12">
					<div class="tabbable">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group col-sm-6">
											<label class="col-sm-3 control-label">债权人(公司):
												</label>
											<div class="col-sm-9">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-2 " style="line-height: 34px;">
												<a onclick="look(${pd.orderId})">去看看>></a>
											</div>
										</div>
									</div>
									<div class="col-md-12">
										...
										<div class="form-group marks col-sm-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-sm-2 no-padding-right" style="width: 12.8%;">报告内容:
												</label>
											<div class="col-sm-10" style="width: 82.8%;">
												<textarea class="form-control" disabled="disabled" style=" height: 120px;resize: none;" rows="15" cols="10" id="remark" name="remark" data-validate="require|maxLength=500">${pd.remark}</textarea>
											</div>
										</div>
									</div>
									<c:if test="${pd.reportType != 1 }">
										<div class="col-md-12" id="hxjhBOX">
											<div class="form-group">
												<label class="control-label col-sm-2 no-padding-right" style="width: 12.8%;">后续计划:
												</label>
												<div class="col-sm-10" style="width: 82.8%;">
									...
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label col-sm-2 no-padding-right" style="width: 12.8%;">审核意见:
												</label>
											<div class="col-sm-10" style="width: 82.8%;">
												<textarea id="content" class="form-control" rows="" name="content" cols="" style="resize: none;"></textarea>
											</div>
										</div>
									</div>
						...
						<div class="text-center">
							...
							<a class="btn btn-mini btn-danger" onclick="save(3);"><i class="fa fa-remove"></i> 驳回</a>
						</div>
					</div>
				</div>
			</div>
