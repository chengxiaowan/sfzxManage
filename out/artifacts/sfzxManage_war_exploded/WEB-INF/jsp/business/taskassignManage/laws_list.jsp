	...
	<div class="wrapper wrapper-content animated fadeInUp">
		...
		<div class="ibox-content">
			<div class="row">
				<div class="col-xs-12">
					<!-- 检索  -->
					<form class="form-inline" role="form" action="taskAssign/sendLawer/list.do" method="post" name="visitForm" id="visitForm">
		...
		<div class="ibox-content">
			...
			<table id="simple-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
					<!-- 开始循环 -->
					<c:choose>
						<c:when test="${not empty lawsList}">
							<c:if test="${QX.cha == 1 }">
								<c:forEach items="${lawsList}" var="list" varStatus="vs">
									<tr>
...
<script type="text/javascript">
	...
	function add() {
		var index = layer.open({
			type : 2,
			title : '新增',
			content : '${pageContext.request.contextPath}/taskAssign/sendLawer/goAdd.do?marks=${pd.marks}',
			area : [ '100%', '100%' ]
		});
		layer.full(index);
	}
