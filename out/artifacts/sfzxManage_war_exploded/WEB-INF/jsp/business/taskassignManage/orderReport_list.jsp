	...
	<div class="wrapper wrapper-content animated fadeInUp">
		...
		<div class="ibox-content">
			<div class="row">
				<div class="col-xs-12">
					<!-- 检索  -->
					<form class="form-inline" role="form" action="taskAssign/orderReport/list.do" method="post" name="visitForm" id="visitForm">
...
<script type="text/javascript">
	...
	function add() {
		var index = layer.open({
			type : 2,
			title : '新增',
			content : '${pageContext.request.contextPath}/taskAssign/orderReport/goAdd.do?marks=${pd.marks}',
			area : [ '90%', '90%' ]
		});
	}
