						...
						<div class="col-xs-12">
							...
							<div class="step-content row-fluid position-relative">
								<div style="float: left; margin-top: 5px;">
									<span class="input-icon"> <input type="text" id="encoderContent" title="输入内容" value="https://www.baidu.com" style="width: 300px;"> <i class="ace-icon fa fa-edit"></i>
									</span>
								</div>
								<div>
									&nbsp;&nbsp;
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div>
														...
														<div>
															<a class="btn btn-mini btn-success" onclick="uploadTwo();">解析</a>
														</div>
													</div>
												</div>
												<!--/widget-main-->
