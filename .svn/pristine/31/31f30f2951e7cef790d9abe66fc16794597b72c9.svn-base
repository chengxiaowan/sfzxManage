...
<body class="gray-bg">
														...
														<div class="col-sm-5" style="width: 100%;">
															<div class="ibox float-e-margins">
																<div class="ibox-content">
																	<div class="alert alert-info">拖拽左侧的表单元素到右侧区域，即可生成相应的HTML代码</div>
																	<form class="form-horizontal m-t">
																		...
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				...
																				<span class="input-icon"> <input type="text" id="form-field-icon-1" /> <i class="ace-icon fa fa-leaf blue"></i>
																				</span> <span class="input-icon input-icon-right"> <input type="text" id="form-field-icon-2" /> <i class="ace-icon fa fa-leaf green"></i>
																				</span>
																				<!-- /section:elements.form.input-icon -->
																			</div>
																		</div>
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9" style="width: 66%;">
																				<div class="selQ653589048Qsel"></div>
																		...
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<div class="fileQ653589048Qfile"></div>
																		...
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<label style="float: left; padding-left: 8px; padding-top: 7px;"> <input name="form-field" type="radio" class="ace" id="form-field-radio1" /> <span class="lbl">单选1</span>
																				</label> <label style="float: left; padding-left: 5px; padding-top: 7px;"> <input name="form-field" type="radio" class="ace" id="form-field-radio2" /> <span class="lbl">单选2</span>
																				</label>
																			</div>
																		</div>
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<label style="float: left; padding-left: 8px; padding-top: 7px;"> <input name="checkbox1" type="checkbox" class="ace" id="checkbox1" /> <span class="lbl">选项1</span>
																				</label> <label style="float: left; padding-left: 5px; padding-top: 7px;"> <input name="checkbox2" type="checkbox" class="ace ace-checkbox-2" id="checkbox2" /> <span class="lbl">选项2</span>
																				</label>
																			</div>
																		</div>
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<label> <input name="switch-field-1" class="ace ace-switch ace-switch-3" type="checkbox" /> <span class="lbl"></span>
																				</label> <label> <input name="switch-field-1" class="ace ace-switch ace-switch-6" type="checkbox" checked="checked" /> <span class="lbl"></span>
																				</label> <label> <input name="switch-field-1" class="ace ace-switch" type="checkbox" /> <span class="lbl" data-lbl="CUS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOM"></span>
																				</label> <label> <input name="switch-field-1" class="ace ace-switch ace-switch-5" type="checkbox" checked="checked" /> <span class="lbl"></span>
																				</label> <label> <input name="switch-field-1" class="ace ace-switch" type="checkbox" /> <span class="lbl" data-lbl="CUS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOM"></span>
																				</label> <label> <input name="switch-field-1" class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" checked="checked" /> <span class="lbl"></span>
																				</label> <label> <input name="switch-field-1" class="ace ace-switch ace-switch-7" type="checkbox" /> <span class="lbl"></span>
																				</label>
																			</div>
																		</div>
																		<div class="form-group draggable">
																		...
																		<div class="form-group draggable">
																			...
																			<div class="col-sm-9">
																				<a class="btn btn-mini btn-primary" onclick="">保存</a> <a class="btn btn-mini btn-danger" onclick="">取消</a>
																			</div>
																		</div>
																	</form>
																</div>
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="ueQ653589048Que"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="ueQ653589048Que"></div>' + uejscode + '<div class="ueQ653589048Que"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="ueQ653589048Que"></div>' + ueditorHtml + '<div class="ueQ653589048Que"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selQ653589048Qsel"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selQ653589048Qsel"></div>' + selectcode + '<div class="selQ653589048Qsel"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="fileQ653589048Qfile"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="fileQ653589048Qfile"></div>' + filecode + '<div class="fileQ653589048Qfile"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="fileQ653589048Qfile"></div>' + fileHtml + '<div class="fileQ653589048Qfile"></div>' + arryFile[2];
				};
			}else{
