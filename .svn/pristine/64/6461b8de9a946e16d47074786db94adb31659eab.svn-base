...
/**
 * The class {@code Client} is a typical wrapper of RPC. Also see {@code com.qiniu.api.auth.DigestAuthClient}
 */
public class Client {
	...
	/**
	 * Sends a http post request to the specified url with a list of <code>NameValuePair<code>.
	 * 
	 * @param url
	 *            the request url
	 * @param nvps
