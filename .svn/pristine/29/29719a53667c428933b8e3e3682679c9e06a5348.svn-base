package com.yocto.controller.fhoa.department;
...
import com.yocto.service.fhoa.department.DepartmentManager;
...
public class DepartmentController extends BaseController {
	...
	public ModelAndView listAllDepartment(Model model, String DEPARTMENT_ID) throws Exception {
		...
		try {
			...
			json = json.replaceAll("DEPARTMENT_ID", "id").replaceAll("PARENT_ID", "pId").replaceAll("NAME", "name").replaceAll("subDepartment", "nodes").replaceAll("hasDepartment", "checked")
