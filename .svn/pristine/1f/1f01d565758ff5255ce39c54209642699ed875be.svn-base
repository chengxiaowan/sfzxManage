...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://odqz5d0wu.bkt.clouddn.com/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //七牛结合需要改成file
        ...
        ,scrawlPath:"http://odqz5d0wu.bkt.clouddn.com/" //URL+"jsp/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"jsp/fileUp.jsp"               //附件上传提交地址
        ,filePath:"http://odqz5d0wu.bkt.clouddn.com/" //URL + "jsp/"                   //附件修正地址，同imagePath
        ...
        ,catcherPath:"http://odqz5d0wu.bkt.clouddn.com/" //URL + "jsp/"                  //图片修正地址，同imagePath
       ...
       // ,separater:'ue_separate_ue'               //提交至后台的远程图片地址字符串分隔符
        ...
        ,imageManagerPath:"http://odqz5d0wu.bkt.clouddn.com/"                                    //图片修正地址，同imagePath
