	...
	<div>
		<table bgcolor="#E3E4D8" width="100%">
			<tr>
				...
				<td width="100"><input type="text" id="suggestId" size="20" value="这里输入搜索地址" style="width: 150px;" />
					</div>
					<div id="searchResultPanel" style="border: 1px solid #C0C0C0; width: 150px; height: auto;"></td>
			</tr>
		</table>
	</div>
	<div id="allmap"></div>
