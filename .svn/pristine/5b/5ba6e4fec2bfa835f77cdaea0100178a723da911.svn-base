package com.yocto.thirdParty.qiniu;

import org.json.JSONException;
import org.json.JSONStringer;

/**
 * The PutPolicy class used to generate a upload token. To upload a file, you should obtain upload authorization from Qiniu cloud strage platform. By a pair of valid accesskey and secretkey, we
 * generate a upload token. When upload a file, the upload token is transmissed as a part of the file stream, or as an accessory part of the HTTP Headers.
 */
