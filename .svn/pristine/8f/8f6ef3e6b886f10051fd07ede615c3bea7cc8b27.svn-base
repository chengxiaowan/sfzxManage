			...
			list_Get() {
				...
				$.get(config.api_detail, {
					...
					if(data.error == '00') {
						that.btn_edit = true;
						if(config.type == 7) {
							if(data.result[0].zbA==null)data.result[0].zbA=0
							if(data.result[0].zbB==null)data.result[0].zbB=0
							if(data.result[0].bfzb==null)data.result[0].bfzb=0
							that.d = data.result;
							that.a=data.result[0].zbA
							that.b=data.result[0].zbB
							that.c=data.result[0].bfzb
							that.xinxi = true;
							that.xinxi_1 = false;
							that.xinxi_2 = false;
						} else {
