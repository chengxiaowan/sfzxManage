			...
			<div class="wrapper wrapper-content animated fadeInUp">
				...
				<div class="ibox-content">
					<div class="row">
						<div class="col-xs-12">
							<!-- 检索  -->
							<form class="form-inline" role="form" action="workBench/ajHktj.do" method="post" name="customerForm" id="customerForm">
								...
								<div class="form-group">
									<input class="span10 date-picker form-control" id="createTimeStart" name="createTimeStart" value="${fn:substring(pd.createTimeStart, 0, 10)}" type="text" data-date-format="yyyy-mm" readonly="readonly" placeholder="月份" title="" />
								</div>
									...
									<c:if test="${QX.cha == 1 }">
										<c:forEach items="${cusList}" var="list" varStatus="vs">
											<tr>
												...
												<td class="center"><a title="点击查看详情" onclick="view('${list.customerId}')" style="cursor: pointer;">${list.custoemrName}</a></td>
